...
class DiaryHousingFormInfo extends Component {
  ...
  render() {
    ...
    const screenTitle = t("info.diaryHousing.title", {
      animalType: translatedAnimalType
    });

    const screenPreface = t("info.diaryHousing.preface", {
      animalType: translatedAnimalType
    });

    const content = t("info.diaryHousing.sections", {
      animalType: translatedAnimalType,
      returnObjects: true
    });
...
export default translate("root")(DiaryHousingFormInfo);
