...
class PainMeasurementDetails extends React.Component {
  ...
  getHorseHeadQuestionFields = () => {
    ...
    return [
      ...
      {
        fieldPath: "chronicMouthCornersScore",
        translationPath: `${basePath}.head.observation.chronicMouthCornersOptions`,
      },
      {
      ...
      {
        fieldPath: "generalAppearanceScore",
        translationPath: `${basePath}.head.observation.generalAppearanceOptions`,
      },
      {
        fieldPath: "bodyPostureScore",
        translationPath: `${basePath}.head.observation.bodyPostureOptions`,
      },
      {
        fieldPath: "weightDistributionScore",
        translationPath: `${basePath}.head.observation.weightDistributionOptions`,
      },
      {
        fieldPath: "weightShiftingOfFrontAndHindLimbsScore",
        translationPath: `${basePath}.head.observation.weightShiftingOfFrontAndHindLimbsOptions`,
      },
      {
        fieldPath: "headCarriageScore",
        translationPath: `${basePath}.head.observation.headCarriageOptions`,
      },
      {
        fieldPath: "musclesScore",
        translationPath: `${basePath}.head.observation.musclesOptions`,
      },
      {
        fieldPath: "painReactionToPalpationOfTheBackScore",
        translationPath: `${basePath}.head.observation.painReactionToPalpationOfTheBackOptions`,
      },
      {
        fieldPath: "painReactionToStandardizedFlexionOfFrontAndHindLimbsScore",
        translationPath: `${basePath}.head.observation.painReactionToStandardizedFlexionOfFrontAndHindLimbsOptions`,
      },
      {
        fieldPath: "carrotappleTestScore",
        translationPath: `${basePath}.head.observation.carrotappleTestOptions`,
      },
      {
        fieldPath: "movementScore",
        translationPath: `${basePath}.head.observation.movementOptions`,
      },
    ];
  };
  ...
  getDonkeyHeadQuestionFields = () => {
    ...
    return [
      ...
      {
        fieldPath: "chronicMouthCornersScore",
        translationPath: `${basePath}.head.observation.donkey.chronicMouthCornersOptions`,
      },
      {
      ...
      {
        fieldPath: "generalAppearanceScore",
        translationPath: `${basePath}.head.observation.donkey.generalAppearanceOptions`,
      },
      {
        fieldPath: "bodyPostureScore",
        translationPath: `${basePath}.head.observation.donkey.bodyPostureOptions`,
      },
      {
        fieldPath: "weightDistributionScore",
        translationPath: `${basePath}.head.observation.donkey.weightDistributionOptions`,
      },
      {
        fieldPath: "weightShiftingOfFrontAndHindLimbsScore",
        translationPath: `${basePath}.head.observation.donkey.weightShiftingOfFrontAndHindLimbsOptions`,
      },
      {
        fieldPath: "headCarriageScore",
        translationPath: `${basePath}.head.observation.donkey.headCarriageOptions`,
      },
      {
        fieldPath: "musclesScore",
        translationPath: `${basePath}.head.observation.donkey.musclesOptions`,
      },
      {
        fieldPath: "painReactionToPalpationOfTheBackScore",
        translationPath: `${basePath}.head.observation.donkey.painReactionToPalpationOfTheBackOptions`,
      },
      {
        fieldPath: "painReactionToStandardizedFlexionOfFrontAndHindLimbsScore",
        translationPath: `${basePath}.head.observation.donkey.painReactionToStandardizedFlexionOfFrontAndHindLimbsOptions`,
      },
      {
        fieldPath: "carrotappleTestScore",
        translationPath: `${basePath}.head.observation.donkey.carrotappleTestOptions`,
      },
      {
        fieldPath: "movementScore",
        translationPath: `${basePath}.head.observation.donkey.movementOptions`,
      },
    ];
  };
  ...
  render() {
    ...
    const fieldTranslationMap = this.getFacialMeasurementTimerFields();
    ...
    const advicePaths = {
      composite: {
        pain: "painMeasurement.misc.adviceCompositeChronicMeasurementPain",
        noPain: "painMeasurement.misc.adviceCompositeChronicMeasurementNoPain",
      },
      head: {
        pain: "painMeasurement.misc.adviceCompositeChronicMeasurementPain",
        noPain: "painMeasurement.misc.adviceCompositeChronicMeasurementNoPain",
