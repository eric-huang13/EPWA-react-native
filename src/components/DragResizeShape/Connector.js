...
export const CONNECTOR_COLOR = '#000';
export const CONNECTOR_BACKGROUND = '#FFF';
    ...
    return (
      <View
        style={{
          ...
          borderRadius: border ? border.radius : size / 2,
          borderColor: border ? border.color : CONNECTOR_COLOR,
          backgroundColor: background || CONNECTOR_BACKGROUND
        }}
